 ...
 * @author Milad
 */
public class jjRssWeather {

    public jjRssWeather(String cityName, String cityDegree, String cityStatus) {
        ...
        tt.schedule(new TimerTask() {
            ...
            public void run() {
                try {
                    ...
                    jjRssWeather teh = getWeather(citys.tehran);
                    jjRssWeather esf = getWeather(citys.esfahan);
                    jjRssWeather mash = getWeather(citys.mashhad);
    ...
    public static jjRssWeather getWeather(citys City) {
        try {
            String name = "";
            String degree = "";
            String status = "";
...
//          String s = Help.getWebSite("http://www.irinn.ir/Default.aspx?TabID=25");
            ...
            return new jjRssWeather(name, degre + "", status);

        } catch (Exception ex) {
//            Help.dialog_ERROR_MESSAGE(ex, null, "getWeather", ex.getMessage());
            return new jjRssWeather("", "", "");
        }
    }
