...
public class jjDbMysql {
    ...
    public jjDbMysql(String userName, String password, String databaseName, String serverHost, String port) {
...
//                        row.addElement(new String(bytes, "windows-1256"));
     ...
     */
//    public static void mySqlBackup(String databaseName, String userName, String password, File backupPath) {
//        try {
//            Runtime.getRuntime().exec(
//                    "\"" + Setting.MYSQL_BACKUPER + "\" -u "
...
//    }
     ...
     * @param userName of mySql
     * @param password of mySql
     * @param backupPath is a path that write backup in that
     */
    public static void mySqlBackup(String databaseName, String userName, String password, String backupPath) {
//        mySqlBackup(databaseName, userName, password, new File(backupPath));
    }
}
